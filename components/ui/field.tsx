...
function FieldLabel({
  ...
  return (
    <Label
      ...
      className={cn(
        'group/field-label flex w-fit leading-snug has-[>[data-slot=field]]:w-full has-[>[data-slot=field]]:flex-col',
        className
      )}
      {...props}
    />
...
function FieldTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="field-label"
      className={cn('flex w-fit items-center leading-snug', className)}
      {...props}
    />
  );
}
